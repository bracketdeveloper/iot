...
/* Edit Staff Form Script*/
function validateEditStaff(staffId, staffEmail) {

    $('body').off('click', '#btn-edit-new-staff');
    $('body').on('click', '#btn-edit-new-staff', function (e) {
        e.preventDefault();
        ...
        formData.append('email', email);
        formData.append('existing_email', staffEmail);
        formData.append('name', name);
        $.ajax({
            url: "admin/ajax_process.php?action=edit_staff",
            type: 'POST',
            contentType: false,
            processData: false,
            data: formData,
            ...
            if (data == "1") {
                Swal.fire({
                    icon: 'success',
                    title: 'Congrats',
                    text: 'Staff is edited',
                }).then((result) => {
                    window.location.replace('edit_member.php?staff_id='+staffId)
                })
...
/* Delete Staff Form Script*/
function validateDeleteStaff(staffId) {

    $('body').off('click', '#btn-delete-staff');
    $('body').on('click', '#btn-delete-staff', function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                formData.append('staff_id', staffId);
                $.ajax({
                    url: "admin/ajax_process.php?action=delete_staff",
                    type: 'POST',
                    contentType: false,
                    processData: false,
                    data: formData,
                    ...
                    if (data == "1") {
                        Swal.fire({
                            ...
                            window.location.replace('staff_members.php')
                        })
                    }
                    /* failed code is 2*/
                    if (data == "2") {
...
/* Add New Tab Form Script*/
function validateNewTab() {

    $('body').off('click', '#btn-add-new-tab');
    $('body').on('click', '#btn-add-new-tab', function (e) {
        e.preventDefault();
        const tabEl = document.getElementById('new-tab');
        ...
        $.ajax({
            url: "admin/ajax_process.php?action=add_new_tab",
            type: 'POST',
            contentType: false,
            processData: false,
            data: formData,
...
/* Edit Tab Form Script*/
function validateEditTab(tabId) {

    $('body').off('click', '#btn-edit-tab');
    $('body').on('click', '#btn-edit-tab', function (e) {
        e.preventDefault();
        ...
        formData.append('tab', tab);
        $.ajax({
            url: "admin/ajax_process.php?action=edit_tab",
            type: 'POST',
            contentType: false,
            processData: false,
            data: formData,
            ...
            if (data == "1") {
                Swal.fire({
                    ...
                    window.location.replace('edit_tab.php?tab_id='+tabId)
                })
...
function validateDeleteTab(tabId) {

    $('body').off('click', '#btn-delete-tab');
    $('body').on('click', '#btn-delete-tab', function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                formData.append('tab_id', tabId);
                $.ajax({
                    url: "admin/ajax_process.php?action=delete_tab",
                    type: 'POST',
                    contentType: false,
                    processData: false,
                    data: formData,
                    ...
                    if (data == "1") {
                        Swal.fire({
                            ...
                            window.location.replace('tabs_details.php')
                        })
                    }
                    /* failed code is 2*/
                    if (data == "2") {
