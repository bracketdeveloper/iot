                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="get">
                            <div class="row">
                                <div class="col-lg-2">
                                    <h4>Start Date</h4>
                                    <input type="date" value="<?php if (isset($_GET['btn_pm25_filter'])){echo $_GET['start_date'];}else{echo $startDate;} ?>"
                                           name="start_date" min="<?php echo $startDate ?>"
                                           max="<?php echo $endDate ?>">
                                </div>
                                <div class="col-lg-2">
                                    <h4>End Date</h4>
                                    <input type="date" value="<?php if (isset($_GET['btn_pm25_filter'])){echo $_GET['end_date'];}else{ echo $endDate;
                                    }?>"
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <button class="btn btn-primary"
                                            type="submit" name="btn_pm25_filter">Get Data
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-bottom: 20px">
                            <button class="btn btn-success col-lg-1" style="margin-left: 10px"
                                    onclick="return getDailyMeanOfData('pm25')">Daily</button>
                            <button class="btn btn-primary col-lg-1" style="margin-left: 10px"
                                    onclick="return getWeeklyMeanOfData('pm25')">Weekly</button>
                            <button class="btn btn-dark col-lg-1" style="margin-left: 10px"
                                    onclick="return getYearlyMeanOfData('pm25')">Yearly</button>
                        </div>
...
<?php require_once "commons/footer.php"; ?>
    <script>
        window.onload = function() {
            ...
            getDailyMeanOfData('pm25');
        };
    </script>

<?php
if (isset($_GET['btn_pm25_filter'])) {
    ...
    if ($startDate > $endDate) {
        ...
        for ($i = 0; $i < sizeof($completeData); $i++):
            ...
            if ($startDate == date('Y-m-d', $date1)):
                for ($j = $i; $j < sizeof($completeData); $j++):
                    ...
                    $dataPointFilterPm25[] =
                        array("x" => $date, "y" => floatval($completeData[$j]['pm25']));
                endfor;
            endif;
        ...
        echo '<script>
                ...
                data: [{
                    ...
                    dataPoints: ' . json_encode($dataPointFilterPm25, JSON_NUMERIC_CHECK) . '
                }]
        });
...
var pm25Chart = new CanvasJS.Chart("pm25-container", {
                ...
                data: [{
                    ...
                    xValueType: "dateTime",
                    xValueFormatString: "DD MMM",
                    dataPoints: '.  json_encode($dataPointPm25, JSON_NUMERIC_CHECK) .'
                }]
            });
