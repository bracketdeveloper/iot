                        ...
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                if (isset($_SESSION['admin']) && $_SESSION['admin'] == 'True'):
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#add-new-tab">
                                            Add New Tab
                                        </button>
                                    </li>
                                <?php
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="add-new-tab">
                                    <h5 class="card-title">Add New Tab</h5>
                                    <!-- Profile Edit Form -->

                                    <div class="row mb-3">
                                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Tab</label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary"
                                                onclick="return validateNewTab()"
                                                id="btn-add-new-tab">Add Tab
                                        </button>
                                    </div>
